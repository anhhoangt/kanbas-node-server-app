...
const todos = [
  ...
  },
  {
    id: 3,
    title: "Task 3.0",
    description: "Create a NodeJS server with ",
    completed: false,
  },
  {
    id: 4,
...
const Lab5 = (app) => {
  ...
  app.get("/a5/module/description/:newDescription", (req, res) => {
    const { newDiscription } = req.params;
    module.description = newDiscription;
